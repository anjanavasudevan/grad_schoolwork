...
\begin{align}
  \vec{v} = \vec{V}^{-1}(\kappa\vec{n}-\vec{u}) \label{eq:4}
\end{align}
where,
\begin{align}
  \kappa = \pm \sqrt[]{\frac{\vec{u}^T\vec{V^{-1}u}-f}{\vec{n}^T\vec{V}^{-1}\vec{n}}} \label{eq:5}
\end{align}
For a circle,
\begin{align}
  \vec{V} = \vec{I}
...
\begin{align}
  ...
  \vec{IX} = \vec{X}
\end{align}
Therefore \eqref{eq:4} and \eqref{eq:5} simplify to:
\begin{align}
