...
\begin{abstract}
This document solves determinant of a matrix using properties of determinants
\end{abstract}
...
\begin{align}
 \xleftrightarrow[]{C_1\rightarrow C_1-C_2}(a-b)(b-c)\mydet{0 & 0 & 1\\0 & 1 & c\\a^2+ab-bc-c^2 & b^2+bc+c^2 & c^3}\\
\implies (a-b)(b-c)\mydet{0 & 0 & 1\\0 & 1 & c\\(a^2-c^2)+b(a-c)& b^2+bc+c^2 & c^3}\\
\implies (a-b)(b-c)\mydet{0 & 0 & 1\\0 & 1 & c\\(a-c)(a+c)+b(a-c) & b^2+bc+c^2 & c^3}\\
\end{align}
Taking $a-c$ from $C_1$, we get
\begin{align}
\implies (a-b)(b-c)(a-c) \mydet{0 & 0 & 1\\0 & 1 & c\\a & b^2+bc+c^2 & c^3}
\end{align}
\end{document}